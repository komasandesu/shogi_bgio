...
import MainViewOffline from './MainView_offline'
import type { Meta, ComponentStoryObj } from '@storybook/react'

const meta: Meta<typeof MainViewOffline> = { component: MainViewOffline }
export default meta

export const Start: ComponentStoryObj<typeof MainViewOffline> = {
  args: {
    G: {
      board: [
    ...
    moves: {
      clickCellOffline: action('clickCell'),
    },
    ctx: {
      currentPlayer: '0',
      gameover: undefined,
